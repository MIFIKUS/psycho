      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
        ...
        <div className="lg:w-2/3 grid sm:grid-cols-2 gap-8">
          {relationshipTopics.map((topic, index) => (
            <div 
              key={index} 
              className="p-8 bg-stone-50 rounded-3xl border border-stone-100 hover:bg-white hover:shadow-xl hover:shadow-stone-200/40 transition-all duration-500 group"
            >
