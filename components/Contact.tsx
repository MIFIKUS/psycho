...
const Contact: React.FC = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      hoverBg: 'hover:bg-fuchsia-200/80',
    ...
    return (
      <div key={method.id} className="relative group">
        <a
          ...
          className={`flex items-center justify-between p-5 md:p-8 bg-[#faf9f6] border border-stone-200/40 shadow-md shadow-stone-200/35 ring-1 ring-stone-900/5 rounded-[1.5rem] md:rounded-[2rem] transition-all duration-500 hover:shadow-xl hover:shadow-stone-300/45 hover:-translate-y-[1px] ${method.hoverBg} ${method.hoverBorder} cursor-pointer`}
        >
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-12">
      <div className="bg-white rounded-[2.5rem] md:rounded-[3.5rem] p-6 md:p-16 lg:p-24 shadow-sm border border-stone-100 flex flex-col gap-10 md:gap-12">
        ...
        <div className="lg:w-1/2 flex flex-col gap-8 md:gap-12">
          ...
          <div className="w-full max-w-2xl overflow-hidden border border-stone-100 bg-stone-50 grayscale touch-none select-none mx-auto lg:mx-0 mt-6 md:mt-10">
            <img
              src="/map.png"
              alt="Карта: кабинет, Владивосток, Всеволода Сибирцева, 15"
              className="w-full h-[280px] md:h-[360px] lg:h-[420px] object-cover block pointer-events-none"
              loading="lazy"
              tabIndex={-1}
              draggable={false}
            />
        ...
        <div className="lg:w-1/2 w-full">
          <div className="mb-6 md:mb-8 space-y-3 text-slate-700 text-base md:text-lg leading-relaxed">
            <p className="font-medium">Выберите удобный для вас способ связи</p>
            <p>В сообщении укажите формат встречи (очно/онлайн, встречу-знакомство/ консультация)</p>
            <p className="font-medium">Отправьте сообщение и я обязательно вам отвечу!</p>
          </div>
        ...
        {phoneMethod ? (
          <div className="hidden lg:grid grid-cols-2 gap-24 items-start">
            <div className="max-w-xl">
              <p className="text-sm md:text-base font-medium text-slate-700 pt-8">
                Офлайн консультации проходят по адресу:
                <br />
                г. Владивосток, ул. Всеволода Сибирцева, д. 15
              </p>
