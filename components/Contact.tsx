...
const Contact: React.FC = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      hoverBg: 'hover:bg-fuchsia-50/90',
      hoverBorder: 'hover:border-fuchsia-200/50',
      color: '',
      type: 'link',
      openInNewTab: true,
    },
    ...
    },
    {
      ...
      hoverBg: 'hover:bg-stone-100/80',
      hoverBorder: 'hover:border-stone-300/40',
    ...
    return (
      <div key={method.id} className="relative group">
        <a
          ...
          className={`flex items-center justify-between py-3 px-4 md:py-3.5 md:px-5 bg-[#faf9f6] border border-stone-200/40 shadow-md shadow-stone-200/35 ring-1 ring-stone-900/5 rounded-xl md:rounded-2xl transition-all duration-500 hover:shadow-md hover:shadow-stone-200/25 ${method.hoverBg} ${method.hoverBorder} cursor-pointer`}
        >
          <div className="flex items-center gap-3 md:gap-4 overflow-hidden">
            <div className={`w-9 h-9 md:w-10 md:h-10 rounded-lg md:rounded-xl flex items-center justify-center transition-all bg-stone-50 group-hover:bg-white group-hover:shadow-inner shrink-0 ${method.color}`}>
              {method.icon}
            </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-12">
      <div className="bg-white rounded-[2.5rem] md:rounded-[3.5rem] p-6 md:p-16 lg:p-24 shadow-sm border border-stone-100 flex flex-col gap-10 md:gap-12">
        ...
        <div className="lg:w-1/2 flex flex-col gap-6 md:gap-8 lg:min-h-0">
          <p className="text-sm md:text-base font-medium text-slate-700 leading-relaxed max-w-md shrink-0">
            Офлайн консультации проходят по адресу:
            <br />
            г. Владивосток, ул. Всеволода Сибирцева, д. 15
          </p>

          <p className="text-lg md:text-xl font-bold text-slate-700 max-w-md mx-auto lg:mx-0 shrink-0">
            Мой телефон:{' '}
            <a href="tel:+79147078435" className="hover:text-sage-800 transition-colors">
              +7 914 707 8435
            </a>
          </p>

          <div className="w-full h-[min(56vw,220px)] min-h-[180px] sm:h-[min(50vw,260px)] sm:min-h-[200px] md:h-[360px] md:min-h-[360px] lg:flex-1 lg:min-h-[280px] lg:h-auto shrink-0 overflow-hidden border border-stone-100 bg-stone-50 mx-auto lg:mx-0 rounded-2xl md:rounded-sm grayscale">
            <OfficeMap />
          </div>
        </div>
        ...
        <div className="lg:w-1/2 w-full flex flex-col">
          <div id="contact" className="scroll-mt-28 mb-6 md:mb-8">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-serif font-medium text-slate-900 leading-tight mb-6 md:mb-8">
              Связаться со мной:
            </h3>
        ...
        <p className="text-center text-2xl md:text-3xl lg:text-4xl font-medium text-sage-800 pt-4 md:pt-6 border-t border-stone-100">
